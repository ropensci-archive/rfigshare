...
#' 
#' Articles must be created with \code{\link{figshare_create}} with essential metadata.  Then you can add files with \code{\link{figshare_upload}}, add categories, tags or authors with \code{\link{figshare_category}} or \code{\link{figshare_tag}} \code{\link{figshare_authors}}.  Authors not registered with a FigShare id can be created with \code{\link{figshare_create_author}}.  You can edit the original metadata with \code{\link{figshare_update}}.  Finally, release the article as either private or public with \code{\link{figshare_private}} or \code{\link{figshare_public}}.  Before creating the article, you must authenticate using \code{\link{figshare_auth}}.     
